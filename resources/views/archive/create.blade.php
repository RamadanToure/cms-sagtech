		...
		<div class="card">
			...
			<div class="card-body"><p class="text-muted"></p>
				<div class="live-preview"><strong><div class="msgAjouter"></div></strong>
					<form action="{{route('archive.store')}}" method="post" id="form" class="row g-3 needs-validation" novalidate enctype='multipart/form-data'>
						@csrf()
							<div class="row">
							...
							<!-- <div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::text('ref_doc','',["id"=>"ref_doc","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Reference" ]) !!}
								</div>
							</div> -->
							<div class="col-md-6">
								<div class="mb-3">
									<label for="sujet_doc" class="form-label">{!!trans('data.sujet_doc')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::text('sujet_doc','',["id"=>"sujet_doc","class"=>"form-control" ,"required"=>"required" ,'autocomplete'=>'off' ,'placeholder'=>"Entrer Sujet" ]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="type_doc" class="form-label">{!!trans('data.type_doc')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::select('type_doc',trans('entite.type_doc_Archive'),null,["id"=>"type_doc","class"=>"form-select allselect" ,"required"=>"required"]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									...
									{!! Form::select('direc_id',$listdirec_id ,'',["id"=>"direc_id","class"=>"form-select allselect" ,"required"=>"required"]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="fichier_doc" class="form-label">{!!trans('data.fichier_doc')!!} <strong style='color: red;'> *</strong></label>
									<input class="form-control" type="file" id="fichier_doc" name="fichier_doc" required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<label for="statut_doc" class="form-label">{!!trans('data.statut_doc')!!} <strong style='color: red;'> *</strong></label>
									{!! Form::select('statut_doc',trans('entite.statut_doc_Archive') ,null,["id"=>"statut_doc","class"=>"form-select allselect" ,"required"=>"required"]) !!}
								</div>
							</div>
							<div class="col-12">
								<div class="text-end">
									<a href="{{route('archive.index')}}" class="btn btn-outline-dark waves-effect mr-10 rounded-pill">Fermer</a>
									@if(in_array('add_archive',session('InfosAction')))
