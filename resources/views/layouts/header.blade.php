                ...
                @if($Cour->count() != 0)
                    <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"> <?php echo count($Cour);?> <span class="visually-hidden">unread messages</span></span>
                        </button>
                                ...
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto dropdown-tabs">
                                            <span class="badge bg-light-subtle text-body fs-13"> {{count($Cour)}} Nouveau</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content position-relative" id="notificationItemsTabContent">
                                <div class="tab-pane fade show active py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        @foreach($Cour as $detail)
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <a href='{{"courrier/consulter/".$detail->code_cour}}' class="stretched-link">
                                                        <h6 class="mt-0 mb-1 fs-13 fw-semibold">{{$detail->ref_cour}}</h6>
                                                    </a>
                                                    <div class="fs-13 text-muted">
                                                        <p class="mb-1">{{$detail->sujet_cour}}</p>
                                                    </div>
                                                    <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                        <span><i class="mdi mdi-clock-outline"></i> {{date('d/m/Y à H:i:s',strtotime($detail->date_rece))}}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
